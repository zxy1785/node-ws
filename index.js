...
const UUID = process.env.UUID || '5efabea4-f6d4-91fd-b8f0-17e114c89c60'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'zxy1785/python-xray-argo';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
